...
const First = () => {
    ...
    return (
        ...
        >
            ...
            <div className="absolute bottom-5 right-0 p-4 flex items-center justify-end">
                <input
                    type="text"
                    value={answer}
                    onChange={(e) => setAnswer(e.target.value)}
                    className={`p-2 rounded ${bgColor} border border-[0.1px] border-slate-600 text-black`}
                />
                <button
